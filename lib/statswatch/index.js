...
const { doQuery, transfersQuery, hasAvailablePositionsQuery, nftBalanceQuery, salesQuery, explorerHeightQuery, getMarketplaceHeight } = require('./gql');
...
const sync = async (_network, fire) => {
    ...
    const marketplaceBlockHeight = await getMarketplaceHeight(_network);
